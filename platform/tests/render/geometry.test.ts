...
describe('renderer geometry',()=>{
 ...
 const r={...(sample as Project).attachments[0],width:200,height:160,pivotX:100,pivotY:0};const a={...(sample as Project).assets[0],originalWidth:100,originalHeight:80,trimX:10,trimY:20,pixelWidth:60,pixelHeight:40};
