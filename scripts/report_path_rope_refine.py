...
p=root/'exercises/path-turnaround/rope-refine'
...
comparison=Image.new('RGB',(660,800),'#20252c')
draw=ImageDraw.Draw(comparison)
cases=[('16 vertices: original','before-selected.png',(370,125,690,205)),('16 vertices: Smooth once','after-selected.png',(370,125,690,205)),('30 vertices: Auto','mesh30-frame15.png',(400,130,660,195)),('30 vertices: Smooth once','mesh30-smooth1-frame15.png',(400,130,660,195))]
for i,(label,name,box) in enumerate(cases):
 draw.text((10,i*200+5),label,font=font,fill='white')
 comparison.paste(Image.open(p/name).convert('RGB').crop(box).resize((640,160)),(10,i*200+30))
comparison.save(p/'comparison.jpg',quality=95)
for a,b,box in [('before-selected.png','restored-selected.png',(350,120,700,210)),('mesh30-frame15.png','mesh30-restored-frame15.png',(400,130,660,195))]:
 print(a,b,ImageChops.difference(Image.open(p/a).convert('RGB').crop(box),Image.open(p/b).convert('RGB').crop(box)).getbbox())
