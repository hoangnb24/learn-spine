...
p=root/'exercises/path-turnaround/rope-six'
...
for i,(label,source) in enumerate([('3 bones, manual weights',root/'exercises/path-turnaround/rope-manual/manual-frame15.png'),('6 bones, auto weights',p/'six-frame15.png')]):
