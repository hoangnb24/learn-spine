...
Ngày: 09/09/2026; cập nhật 11/09/2026. Trạng thái: đã có [bộ mẫu nguồn](research/assets.md), [hợp đồng v0](contracts/README.md) và [probe WebMCP với bằng chứng thực tế](research/webmcp.md) đã merge vào `main` qua [PR #30](https://github.com/hoangnb24/learn-spine/pull/30). #2–#6, #8 và #10 đã Done: workspace, model, tính pose và lưu project đã được nghiệm thu. #7 đang review; #9 đang triển khai renderer. Chưa có workflow animation hoàn chỉnh hoặc số đo của ba gate.
